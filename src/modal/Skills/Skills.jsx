...
function Skills({currentLang}) {
  ...
  if (currentLang === 'en') {
    ...
    const traductionDescriptions = [
        ["J'essaye d'apporter une touche d'originalité dans tous ce que je fais, j'aime élaborer des idées nouvelles et des solutions pratiques. On m'a toujours dit que je pensais différemment et j'en fais une force, je fais en sorte que chaque résultat soit unique, de valeur et qualitatif.",
        ...
        ["J'adore être face à des défis, je les aborde avec ma logique et les traites avec clarté. J'analyse les problèmes, trouve des solutions et mets en place celle qui est le plus adapté. Je les transformes en opportunités d'apprentissage pour toujours m'améliorer.",
